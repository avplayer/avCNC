...
#ifndef AVCNC_COROUTINE_HPP
#define AVCNC_COROUTINE_HPP
 ...
 *
 * @li @c AVCNC_CORO_REENTER instead of @c reenter
 * @li @c AVCNC_CORO_YIELD instead of @c yield
 * @li @c AVCNC_CORO_FORK instead of @c fork
 */
class coroutine
{
public:
...
#define AVCNC_CORO_REENTER(c)                               \
  switch (::avCNC::coro::detail::coroutine_ref _coro_value = c) \
...
#define AVCNC_CORO_YIELD_IMPL(n) \
  for (_coro_value = (n);;) \
    if (_coro_value == 0) \
    { \
      case (n): ; \
...
#if defined(_MSC_VER)
# define AVCNC_CORO_YIELD AVCNC_CORO_YIELD_IMPL(__COUNTER__ + 1)
# define AVCNC_CORO_FORK AVCNC_CORO_FORK_IMPL(__COUNTER__ + 1)
#else // defined(_MSC_VER)
# define AVCNC_CORO_YIELD AVCNC_CORO_YIELD_IMPL(__LINE__)
# define AVCNC_CORO_FORK AVCNC_CORO_FORK_IMPL(__LINE__)
#endif // defined(_MSC_VER)

#endif // AVCNC_COROUTINE_HPP
